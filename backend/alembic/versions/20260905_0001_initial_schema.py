...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(length=36), nullable=False),
        sa.Column("user_id", sa.String(length=36), nullable=False),
        sa.Column("growth_session_id", sa.String(length=36), nullable=True),
        sa.Column("growth_report_id", sa.String(length=36), nullable=True),
        sa.Column("todo_id", sa.String(length=36), nullable=False),
        sa.Column("phase_key", sa.String(length=20), nullable=False),
        sa.Column("plan_task_index", sa.Integer(), nullable=False),
