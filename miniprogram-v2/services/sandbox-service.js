...
function resume(userId, sessionId, message) { return request({ method: "POST", url: "/api/v1/sandbox/resume", data: { user_id: userId, session_id: sessionId, message: message || "" } }); }
